...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: the order of the people on the list is not correct after queue. The method in the person queue is not correct.
    ...
    // Defect(s) Found: person queue is working properly after change in method
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: infinite turns not working properly changed at main file for better condition
    ...
    // Defect(s) Found: fixed negative turns to be infinite turns condition
